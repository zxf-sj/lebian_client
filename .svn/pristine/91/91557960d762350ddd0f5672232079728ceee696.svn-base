...
Page({
    ...
    selectCity: function (e) {
        ...
        app.globalData.lineLat = lat;
        app.globalData.lineLng = lng;
        app.globalData.strAddress = '出发地';
        app.globalData.strLatitude =lat;
        app.globalData.strLongitude = lng;
        app.globalData.destinationCity = city;
        wx.setStorageSync('locationCity',city);
        wx.navigateTo({
          url: '/pages/goWhere/goWhere',
        })
    },
