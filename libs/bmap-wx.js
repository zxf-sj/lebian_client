...
class BMapWX {
  ...
  constructor(param) {
    this.key = param["key"];
  this.baseUrl = param["test"] ? 'https://test-pass-api.ibtmap.com/b/wx/' : 'https://pass-api.ibtmap.com/b/wx/';
  }
  ...
  search(param) {
    ...
    let locationsuccess = function (result) {
      ...
      wx.request({
        url: that.baseUrl + 'place/v2/search',
        data: searchparam,
        header: {
          "content-type": "application/json", "x-outwrap": "0"
        },
        method: 'GET',
        success(data) {
          let res = data["data"];
  ...
  suggestion(param) {
    ...
    wx.request({
      url: that.baseUrl + 'place/v2/suggestion',
  ...
  regeocoding (param) {
    ...
    let locationsuccess = function (result) {
      ...
      wx.request({
        url: that.baseUrl + 'reverse_geocoding/v3',
  ...
  weather(param) {
    ...
    let locationsuccess = function (result) {
      ...
      wx.request({
        url: that.baseUrl + 'telematics/v3/weather',
        data: weatherparam,
        header: {
          "content-type": "application/json", "x-outwrap": "0"
        },
